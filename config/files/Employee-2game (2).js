...
class Game {
	...
	init() {
		...
		const light1 = new THREE.SpotLight(0xaaaaaa, 1, 1000, Math.PI / 4, 0.5, 0.5);
		light1.position.set(1000, 500, 1000);
		light1.target.position.set(0, 0, 0);
		this.scene.add(light1);
		this.scene.add(light1.target);

		const light2 = new THREE.SpotLight(0xaaaaaa, 1, 1000, Math.PI / 4, 0.5, 0.5);
		light2.position.set(0, 500, 200);
		light2.target.position.set(0, 0, 500);
		this.scene.add(light2);
		this.scene.add(light2.target);

		const light3 = new THREE.SpotLight(0xaaaaaa, 1, 1000, Math.PI / 4, 0.5, 0.5);
		light3.position.set(-1000, 500, 1000);
		light3.target.position.set(0, 0, 0);
		this.scene.add(light3);
		this.scene.add(light3.target);

		const light4 = new THREE.SpotLight(0xaaaaaa, 1, 1000, Math.PI / 4, 0.5, 0.5);
		light4.position.set(0, 500, 1500);
		light4.target.position.set(0, 0, 500);
		this.scene.add(light4);
		this.scene.add(light4.target);

		const light = new THREE.DirectionalLight(0xaaaaaa, 0.75);
		...
		this.nameBubble.mesh.position.set(0, 350, 0);
	...
	createCameras() {
		...
		front.position.set(112, 100, 700);
...
class PlayerLocal extends Player {
	constructor(game, model) {
		...
		socket.on('chat message', function (data) {
			...
			// game.nameBubble.updateName("KANISHK BHARDWAJ");
		});
	...
	move(dt) {
		...
		if (!blocked) {
			if (this.motion.forward > 0) {
				const speed = (this.action == 'Running') ? 700 : 250;
