...
class JoyStick{
	constructor(options){
		...
		circle.style.cssText = "position:absolute; bottom:35px; width:80px; height:80px; background:rgba(126, 126, 126, 0.5); border:#fff solid thin; border-radius:50%; left:50%; transform:translateX(-50%);";
